...
async function fetchOverallConsumptionRate() {
    try {
        const response = await fetch('http://localhost:5000/api/overall_consumption_rate'); // Adjusted URL for API
        const data = await response.json();
...
async function fetchTotalMachinesRunning() {
    try {
        const response = await fetch('http://localhost:5000/api/total_machines_running'); // Adjusted URL for API
        const data = await response.json();
...
async function fetchOtifPercentage() {
    try {
        const response = await fetch('http://localhost:5000/api/otif_percentage'); // Adjusted URL for API
        const data = await response.json();
